...
function getSize( elem ) {
  ...
  var paddingWidth = size.paddingRight + size.paddingLeft;
  var paddingHeight = size.paddingTop + size.paddingBottom;
  var marginWidth = size.marginRight + size.marginLeft;
  var marginHeight = size.marginTop + size.marginBottom;
  var borderWidth = size.borderRightWidth + size.borderLeftWidth;
...
Item.prototype.getPosition = function() {
  ...
  var isOriginRight = layoutOptions.isOriginRight;
  var isOriginTop = layoutOptions.isOriginTop;
  var x = parseInt( style[ isOriginRight ? 'right' : 'left' ], 10 );
  ...
  x -= isOriginRight ? layoutSize.paddingRight : layoutSize.paddingLeft;
...
Item.prototype.layoutPosition = function() {
  ...
  if ( layoutOptions.isOriginRight ) {
...
Item.prototype._transitionTo = function( x, y ) {
  this.getPosition();
  // get current x & y from top/right
  ...
  var transY = y - curY;
  var transitionStyle = {};
  // flip cooridinates if origin on left or bottom
  var layoutOptions = this.layout.options;
  transX = layoutOptions.isOriginRight ? transX : -transX;
...
Outlayer.prototype._setContainerMeasure = function( measure, isWidth ) {
  ...
  if ( elemSize.isBorderBox ) {
    measure += isWidth ? elemSize.paddingRight + elemSize.paddingLeft +
 ...
 * @param {Element} elem
 * @returns {Object} offset - has right, top, left, bottom
 */
Outlayer.prototype._getElementOffset = function( elem ) {
  ...
  var offset = {
    right: boundingRect.right - thisRect.right - size.marginRight,
    top: boundingRect.top - thisRect.top - size.marginTop,
    left: thisRect.left - boundingRect.left - size.marginLeft,
...
function masonryDefinition( Outlayer, getSize ) {
  ...
  Masonry.prototype._manageStamp = function( stamp ) {
    ...
    var firstX = this.options.isOriginRight ? offset.right : offset.left;
